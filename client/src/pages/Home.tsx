...
export default function Home() {
  ...
  useSEO({
    ...
    description: 'Velas aromáticas artesanais feitas com essências naturais. Descubra o aroma perfeito para seu espaço.',
    keywords: ['velas aromáticas', 'velas artesanais', 'essências naturais', 'decoração', 'aromaterapia'],
    type: 'website',
  });
  ...
  return (
    <PublicLayout config={config || undefined}>
      ...
      <section className="py-16 px-4 bg-teal-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Aproveite!</h2>
